...
static pixmap_t *
pixmap_rescale_swscale(const AVFrame *pict, int src_pix_fmt,
                                        int src_w, int src_h,
                                        int dst_w, int dst_h,
                                        int with_alpha, int margin);

pixmap_t *
image_decode_ffmpeg(image_coded_type_t type,
 ...
 */
static pixmap_t *
fulhack(const AVFrame *pict, int src_w, int src_h,
...
static pixmap_t *
pixmap_32bit_swizzle(AVFrame *pict, int pix_fmt, int w, int h, int m)
{
 ...
 */
static pixmap_t *
pixmap_from_avpic(AVFrame *pict, int pix_fmt,
		  int src_w, int src_h,
